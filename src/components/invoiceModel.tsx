...
const InvoiceModal = () => {
  ...
  return (
    <div className="absolute flex items-center justify-center h-full w-full rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
