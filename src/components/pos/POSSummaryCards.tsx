    ...
    return (
        ...
        <div className="grid grid-cols-4 gap-3 mb-3">
            {summaryCards.map((stat, i) => (
                <div
                    key={i}
                    className={`flex items-center p-3 space-x-3 transition-all bg-white rounded-2xl border border-gray-200 ${stat.bgGlow || ''} cursor-pointer group relative overflow-hidden`}
                >
