...
interface CartPanelProps {cartItems: CartItem[];
    itemsCount: number;
...
export const CartPanel = ({
    ...
    return (
        <>
            <div className="col-span-5 bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-xl p-4 flex flex-col overflow-hidden border border-gray-200">
                {/* Header */}
