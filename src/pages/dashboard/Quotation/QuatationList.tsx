    ...
    <div className={"flex flex-col gap-4 h-full"}>
      ...
      <div className={"bg-white rounded-md p-4 flex flex-col"}>
        ...
        <div className={"grid md:grid-cols-4 gap-4 "}>
          ...
          <div
            className={
              "grid grid-cols-2 md:items-end items-start gap-2 text-white font-medium"
            }
          >
            <button
              className={
                "bg-emerald-600 py-2 rounded-md flex items-center justify-center"
              }
            >
            ...
            <button
              className={
                "bg-gray-500 py-2 rounded-md flex items-center justify-center"
              }
            >
                ...
                >
                  ...
                  <td className="px-6 py-2 whitespace-nowrap text-sm font-medium">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="relative group">
                        <button className="p-2 bg-red-100 rounded-full text-red-700 hover:bg-red-200 transition-colors">
