                                            ...
                                            <table className="w-full border-collapse">
                                                <thead>
                                                    <tr className="border-b border-gray-100 bg-gray-50/50">
                                                        <th className="text-left py-2 px-2 text-xs font-bold text-gray-400 uppercase">Product</th>
                                                        <th className="text-right py-2 px-2 text-xs font-bold text-gray-400 uppercase">Cost</th>
                                                        <th className="text-right py-2 px-2 text-xs font-bold text-gray-400 uppercase">Price</th>
                                                        <th className="text-center py-2 px-2 text-xs font-bold text-gray-400 uppercase">Qty</th>
                                                        <th className="text-right py-2 px-2 text-xs font-bold text-emerald-600 uppercase">Profit</th>
                                                        <th className="text-right py-2 px-2 text-xs font-bold text-gray-800 uppercase">Total</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                        ...
                                        <div className="flex justify-between gap-6 pt-4 border-t">
                                            ...
                                            <div className="w-72 space-y-2">
                                                <div className="flex justify-between text-sm">
                                                    ...
                                                    <span className="font-bold text-gray-700">{formatCurrency(selectedInvoiceDetails.subTotal)}</span>
                                                </div>
                                                <div className="flex justify-between text-sm">
                                                ...
                                                <div className="flex justify-between text-md font-bold text-blue-600 px-2">
                                                    ...
                                                    <span>{formatCurrency(selectedInvoiceDetails.profit)}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
