            ...
            <div className={'flex flex-col gap-4 h-full'}>
                ...
                <div className={'grid md:grid-cols-3 grid-cols-1 gap-4'}>
                    {summaryCards.map((stat, i) => (
                        <div
                            key={i}
                            className={`flex items-center p-4 space-x-3 transition-all bg-white rounded-xl border border-gray-200 ${stat.bgGlow} cursor-pointer group relative overflow-hidden`}
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-transparent via-gray-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                            <div className={`p-3 ${stat.color}  relative z-10`}>
                ...
                <div className={'bg-white rounded-xl border border-gray-200 p-4 flex flex-col '}>
                    ...
                    <div className={'grid md:grid-cols-4 gap-4'}>
                        ...
                        <div className={'grid grid-cols-2 md:items-end items-start gap-2 text-white font-medium'}>
                            <button className={'bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 py-2 rounded-lg flex items-center justify-center transition-all'}>
                                <SearchCheck className="mr-2" size={14} />Search
                            </button>
                            <button className={'bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 py-2 rounded-lg flex items-center justify-center transition-all'}>
                ...
                <div className={'flex flex-col bg-white border border-gray-200 rounded-xl h-full p-4 justify-between '}>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-2 whitespace-nowrap text-sm font-medium">
                                            <div className="flex gap-2">
                                                <button className="p-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg  hover: transition-all">
                                                    <Eye size={16} />
                                                </button>
                                                <button className="p-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-lg  hover: transition-all">
                                                    <Printer size={16} />
                                                </button>
                                            </div>
                                        </td>
                    ...
                    <nav className="bg-white flex items-center justify-center sm:px-6 pt-4 border-t-2 border-gray-100">
                        <div className="flex items-center space-x-2">
                            ...
                            <button className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-sm font-semibold rounded-lg text-white ">
                                1
                            </button>
