            ...
            >
                <div className="overflow-y-auto max-h-md md:h-[320px] lg:h-[500px] rounded-lg scrollbar-thin scrollbar-thumb-red-300 scrollbar-track-gray-100">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            {['Product ID', 'Product Name', 'Unit', 'Discount', 'Cost Price', 'MRP', 'Price', 'Supplier', 'Stock'].map((header, i, arr) => (
                                <th
                                    key={i}
                                    scope="col"
                            ...
                            currentSalesData.map((sale, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-2 whitespace-nowrap">
                                            <span className="px-3 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-red-100 to-red-200 text-red-800">
                                                {sale.stock}
                                            </span>
                                    </td>
                                </tr>
