...
function OutOfStock() {
    ...
    <>
      <div className="w-full ps-5 ">
        <div>
          <Breadcrumbs>
            ...
            <BreadcrumbItem>Out of Stock</BreadcrumbItem>
          </Breadcrumbs>
        </div>
        <div className="text-4xl font-medium text-gray-400">Out of Stock</div>
      </div>
      ...
      <div className="bg-white mt-5 rounded-2xl w-full ">
        <div className="grid grid-cols-7 gap-5 bg-[#EF4444] h-12 rounded-md items-center text-white text-xs font-medium min-w-5xl">
