...
function Accounts() {
    ...
    const summaryCards = [
        ...
        },
        {
            ...
            iconColor: 'text-white',
            bgGlow: stats.totalDifferences >= 0 ? 'shadow-emerald-200' : 'shadow-red-200'
        }
    ];
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white font-semibold rounded-xl shadow-lg transition-all"
                        >
                            <Filter size={18} />
                            Filters
                        </button>
                        <button
                            onClick={exportToCSV}
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold rounded-xl shadow-lg shadow-emerald-200 transition-all"
                        >
                            <Download size={18} />
                            Export
                        </button>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 text-sm border-2 border-gray-200 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none"
                                >
                            ...
                            {currentSessions.length === 0 ? (
                                ...
                                currentSessions.map((session, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadge(session.status)} shadow-md`}>
                                                {session.status}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className="p-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white rounded-lg transition-all shadow-md hover:shadow-lg"
                                                    title="View Details"
                                                >
                                                    <Eye size={16} />
                                                </button>
