            ...
            <div className={'flex flex-col bg-white rounded-md  p-4 justify-between gap-8'}>
                ...
                <div className={'grid md:grid-cols-5 gap-4 '}>
                    <div>
                        ...
                        <input type="text" id="search-Brand" placeholder="Search Brand..."
                    ...
                    <div>
                        ...
                        <input type="text" id="new-Brand" placeholder="Enter New Brand Name"
                               className="w-full text-sm rounded-md py-2 px-2 border-2 border-gray-100 focus:border-emerald-500 focus:ring-emerald-500" />
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md relative ">
                        ...
                        <div className="space-y-4">
                            <p className="text-sm text-gray-600">
                                Current Brand Name :
                                <span className="font-semibold text-teal-600 ml-2">{selectedBrand.BrandName}</span>
                            </p>
                            <div>
