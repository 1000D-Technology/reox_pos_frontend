    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-4 min-h-[calc(100vh-120px)]">
                ...
                <div
                    className={"flex flex-col bg-white rounded-xl h-full p-6 justify-between border border-gray-200 mt-6"}
                >
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {isLoadingProducts ? (
                                    ...
                                    currentPageData.map((product: Product, index: number) => (
                                        <tr
                    ...
                    <nav className="bg-white flex items-center justify-between sm:px-6 pt-4 border-t-2 border-gray-100">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            {getPageNumbers().map((page: any, idx: number) => (
                                typeof page === 'number' ? (
                                    <button
                                        key={idx}
