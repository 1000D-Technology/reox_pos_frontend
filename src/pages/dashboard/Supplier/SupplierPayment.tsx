import {
    ...
    ChartNoAxesCombined,
    ChevronLeft,
    ChevronRight, Copy, DollarSign, Download, Eye, FileSpreadsheet,
    HandCoins,
    Printer,
    RefreshCw,
    Save,
                ...
                <div className={'bg-white rounded-md p-4 flex flex-col'}>
                    ...
                    <div className={'grid md:grid-cols-5 gap-4 '}>
                        <div>
                            ...
                            <input type="text" id="invoice-number" placeholder="Type to search supplier"
                        ...
                        <div>
                            ...
                            <input type="text" id="from-date" placeholder="Type to select Bil Number..."
                                className="w-full text-sm rounded-md py-2 px-2  border-2 border-gray-100 " />

                        </div>
                        <div>
                            <label htmlFor="to-date"
                                className="block text-sm font-medium text-gray-500 mb-1">Total: LKR58400.00</label>
                            <label className="text-xl font-semibold">Balance: <label className="text-green-700">LKR5800.00</label></label>
                        </div>
                        <div>
                            <label htmlFor="to-date"
                                className="block text-sm font-medium text-gray-700 mb-1">New Payment</label>
                            <input type="Text" id="to-date" placeholder="Enter Amount..."
                                className="w-full text-sm rounded-md py-2 px-2  border-2 border-gray-100 " />
