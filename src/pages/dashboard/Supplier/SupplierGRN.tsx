            ...
            <div className={'flex flex-col gap-4 h-full'}>
                <div>
                    <div className="text-sm text-gray-500 flex items-center">
                        ...
                        <span className="text-black">Supplier GRN History</span>
                    </div>
                    <h1 className="text-3xl font-semibold text-gray-500">Supplier GRN History</h1>
                </div>
                ...
                <div className={'bg-white rounded-md p-4 flex flex-col'}>
                    ...
                    <div className={'grid md:grid-cols-5 gap-4 '}>
                        ...
                        <div>
                            <label htmlFor="to-date"
                                className="block text-sm font-medium text-gray-700 mb-1">Select Status</label>
                            <input type="Text" id="to-date" placeholder="Select"
                                className="w-full text-sm rounded-md py-2 px-2  border-2 border-gray-100 " />
